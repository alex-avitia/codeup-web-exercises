...
navBarBrand[0].innerHTML = "Alex's";

console.log(navBarBrand.innerHTML);
...
var bestSeller = document.getElementsByClassName('hat-sold');

bestSeller[0].innerHTML = "Wide-brimmed Stetsons for hipsters";
bestSeller[1].innerHTML = "Dad hats";
bestSeller[2].innerHTML = "Yellow foam 'The Big Cheese' hats";
...
for (i = 0; i < specialOffers.length; i++) {
    specialOffers[i].innerHTML = "New discounts coming soon!";
}
...
var navDemo = document.getElementById("navbarTogglerDemo02");
...
navDemo.setAttribute("id" ,'navbar-collapser');
...
navDemo.setAttribute("data-target", "navbar-collapser");
...
var mainColor = document.getElementsByClassName("main-content");
var headerColor = document.getElementById("top-header");
bodyColor.style['background-color'] = "navajowhite";
mainColor.style['background-color'] = "navajowhite";
headerColor.style.color = "navajowhite";
